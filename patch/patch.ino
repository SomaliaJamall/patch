...
void setup(void)
{
  ...
  //matrix.fillScreen(0);
    drawThey(matrix.Color(100,100,100));
...
void loop(void)
{
  ...
  matrix.fillScreen(0);
  if(buttnum == 1){
    drawThey(matrix.Color(red, green, blue));
  }else if(buttnum == 2){
    drawHe(matrix.Color(red, green, blue));
  }
  else if(buttnum == 3){
    drawCancer(matrix.Color(red, green, blue));
  }
  else if(buttnum == 4){
    drawHeart(matrix.Color(red, green, blue));
  }
  else if(buttnum == 5){
    drawEye(matrix.Color(red, green, blue));
  }
  else if(buttnum == 6){
    drawShe(matrix.Color(red, green, blue));
  }
  else if(buttnum == 7){
    drawHeart(matrix.Color(red, green, blue));
  }
...
void drawThey(uint32_t c){
  Serial.println("Draw They");
  //draw T
  matrix.drawLine(0, 7, 0, 5, c); // x0, y0, x1, y1, color
  matrix.drawLine(1, 6,3, 6, c); // x0, y0, x1, y1, color

  //draw H
  matrix.drawLine(0, 3, 3, 3, c); // x0, y0, x1, y1, color
  matrix.drawLine(0, 1, 3, 1, c); // x0, y0, x1, y1, color
  matrix.drawLine(1,3,1,1, c); // x0, y0, x1, y1, color
  matrix.drawLine(2,3,2,1, c); // x0, y0, x1, y1, color

  //draw E
  matrix.drawLine(5,7,7,7, c); // x0, y0, x1, y1, color
  matrix.drawLine(5,7,5,5, c); // x0, y0, x1, y1, color
  matrix.drawPixel(6,6, c); // x0, y0, x1, y1, color
  matrix.drawLine(7,7,7,5, c); // x0, y0, x1, y1, color

  //draw Y
  matrix.drawPixel(5,3, c); // x0, y0, x1, y1, color
  matrix.drawPixel(5,1, c); // x0, y0, x1, y1, color
  //matrix.drawLine(4,3, 5,3, c); // x0, y0, x1, y1, color
  //matrix.drawLine(4,1,5,1, c); // x0, y0, x1, y1, color
  matrix.drawLine(6,2,7,2, c); // x0, y0, x1, y1, color
  
}

//8x8
void drawHe(uint32_t c){
  //draw H
  matrix.drawLine(2,7,5,7, c); // x0, y0, x1, y1, color
  matrix.drawLine(2,5,5,5, c); // x0, y0, x1, y1, color
  matrix.drawLine(3,7,3,5, c); // x0, y0, x1, y1, color
  matrix.drawLine(4,7,4,5, c); // x0, y0, x1, y1, color

  //draw E
  matrix.drawLine(2,3,5,3, c); // x0, y0, x1, y1, color
  matrix.drawLine(2,3,2,1, c); // x0, y0, x1, y1, color
  matrix.drawPixel(3,2, c); // x0, y0, x1, y1, color
  matrix.drawLine(5,3,5,1, c); // x0, y0, x1, y1, color
  matrix.show();
}

//8x8
void drawShe(uint32_t c){
  //draw S
  matrix.drawLine(0,6,0,5, c); // x0, y0, x1, y1, color
  matrix.drawLine(1,6,2,5, c); // x0, y0, x1, y1, color
  matrix.drawLine(3,6,3,5, c); // x0, y0, x1, y1, color
  
  //draw H
  matrix.drawLine(0,3,3,3, c); // x0, y0, x1, y1, color
  matrix.drawLine(0,1,3,1, c); // x0, y0, x1, y1, color
  matrix.drawPixel(1,2, c); // x0, y0, x1, y1, color
  matrix.drawPixel(2,2, c); // x0, y0, x1, y1, color

  //draw E
  matrix.drawLine(5,5,5,3, c); // x0, y0, x1, y1, color
  matrix.drawLine(5,5,7,5, c); // x0, y0, x1, y1, color
  matrix.drawPixel(6,4,c); // x0, y0, x1, y1, color
  matrix.drawLine(7,5,7,3, c); // x0, y0, x1, y1, color
  matrix.show();
}

//8x8
void drawHeart(uint32_t c){
  matrix.drawPixel(2,3,c); // x0, y0, x1, y1, color
  matrix.drawLine(1,2,1,1, c); // x0, y0, x1, y1, color
  matrix.drawLine(2,0,4,0, c); // x0, y0, x1, y1, color
  matrix.drawLine(5,1,7,3, c); // x0, y0, x1, y1, color
  matrix.drawLine(6,4,4,6, c); // x0, y0, x1, y1, color
  matrix.drawLine(3,6,2,6, c); // x0, y0, x1, y1, color
  matrix.drawLine(1,5,1,4, c); // x0, y0, x1, y1, color
  matrix.show();
}

//8x8
void drawEye(uint32_t c){
  matrix.drawPixel(2,6,c); // x0, y0, x1, y1, color
  matrix.drawPixel(2,1,c); // x0, y0, x1, y1, color
  matrix.drawPixel(5,6,c); // x0, y0, x1, y1, color
  matrix.drawPixel(5,1,c); // x0, y0, x1, y1, color

  matrix.drawPixel(0,5,c); // x0, y0, x1, y1, color
  matrix.drawPixel(0,3,c); // x0, y0, x1, y1, color
  matrix.drawPixel(7,5,c); // x0, y0, x1, y1, color
  matrix.drawPixel(7,3,c); // x0, y0, x1, y1, color
  
  matrix.drawLine(1,5,1,2, c); // x0, y0, x1, y1, color
  matrix.drawLine(3,0,4,0, c); // x0, y0, x1, y1, color
  matrix.drawLine(6,2,6,5, c); // x0, y0, x1, y1, color
  matrix.drawLine(4,7,3,7, c); // x0, y0, x1, y1, color

  matrix.drawLine(3,4,3,3, c); // x0, y0, x1, y1, color
  matrix.drawLine(4,4,4,3, c); // x0, y0, x1, y1, color
  matrix.show();
}

//8x8
void drawCancer(uint32_t c){
  matrix.drawPixel(2,5,c); // x0, y0, x1, y1, color
  matrix.drawPixel(3,6,c); // x0, y0, x1, y1, color
  matrix.drawPixel(3,4,c); // x0, y0, x1, y1, color
  matrix.drawPixel(4,5,c); // x0, y0, x1, y1, color

  matrix.drawPixel(3,1,c); // x0, y0, x1, y1, color
  matrix.drawPixel(4,2,c); // x0, y0, x1, y1, color
  matrix.drawPixel(4,0,c); // x0, y0, x1, y1, color
  matrix.drawPixel(5,1,c); // x0, y0, x1, y1, color
  
  matrix.drawLine(1,4,1,1, c); // x0, y0, x1, y1, color
  matrix.drawLine(6,5,6,2, c); // x0, y0, x1, y1, color
  matrix.show();
}
